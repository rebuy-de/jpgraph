...
class DatamatrixBackendFactory {
    ...
    CONST BACKEND_ASCII = 0;

    CONST BACKEND_IMAGE = 1;

    CONST BACKEND_PS = 2;

    CONST BACKEND_EPS = 3;

    static function Create(&$aDMSpec,$aBackend=DatamatrixBackendFactory::BACKEND_IMAGE) {
        switch( $aBackend ) {
        case DatamatrixBackendFactory::BACKEND_ASCII:
            return new BackendMatrix_ASCII($aDMSpec);
            break;
        case DatamatrixBackendFactory::BACKEND_IMAGE:
            return new BackendMatrix_Image($aDMSpec);
            break;
        case DatamatrixBackendFactory::BACKEND_PS:
            return new BackendMatrix_PS($aDMSpec);
            break;
        case DatamatrixBackendFactory::BACKEND_EPS:
